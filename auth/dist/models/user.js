...
exports.verifyPassword = exports.generatePasswordHash = exports.userFromEmail = exports.userFromUsername = exports.loginUser = exports.createUser = void 0;
...
const loginUser = (username, password) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { rows } = result;
    if (rows.length !== 0) {
        const verified = yield (0, exports.verifyPassword)(password, rows[0].password_hash);
        if (verified) {
            return rows[0];
        }
    }
...
const userFromEmail = (email) => __awaiter(void 0, void 0, void 0, function* () {
    const query = {
...
exports.userFromEmail = userFromEmail;
