// import { AbstractMesh, AnimationGroup, Color4, Engine, Scene, SceneLoader, Vector3 } from '@babylonjs/core';
...
//     this._menuId = menuId;
//     const characterNameLabel = new TextBlock(`${this._menuId}__character_name`, 'Character Name:');
//     characterNameLabel.color = 'white';
//     characterNameLabel.height = '40px';

//     const characterNameInput = new InputText(`${this._menuId}__character_name_input`);
//     characterNameInput.width = '400px';
//     characterNameInput.height = '40px';
//     characterNameInput.color = 'white';
//     const raceGrid = raceSelect(this._menuId, (race: RaceName) => this._setRace(race));
//     const genderGrid = genderSelect(this._menuId, (gender: 'm' | 'f') => this._setGender(gender));
//     const characterPanel = new StackPanel(`${this._menuId}__character_stack`);
//     characterPanel.adaptWidthToChildren = true;
//     this._descriptionText = new TextBlock(`${this._menuId}__race_description`, '');
...
//     const characterSelectScene = await SceneLoader.ImportMeshAsync(null, '', CharacterCreateScene, this.scene);
...
//     this._attributesPanel && this.menu.addControl(this._attributesPanel.attributesPanel);
...
//         this.camera.heightOffset = this._characters[character].cameraHeightOffset;
//       }
//     }
//   }
...
//     this._attributesPanel?.updateAttributes(attibutes);
//     this._setModelVisibility();
//   }
// }
