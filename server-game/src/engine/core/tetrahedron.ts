...
export class Tetrahedron {
  ...
  calculateCircumsphere() {
    ...
    this._circumradiusSquared = (dx * dx + dy * dy + dz * dz - 4 * a * c) / (4 * a * a);
  }
  ...
  containsVertex(v: Vector3) {
    return almostEquals(v, this._a) || almostEquals(v, this._b) || almostEquals(v, this._c) || almostEquals(v, this._d);
  }
  ...
  equals(t: Tetrahedron) {
    return (
      (this._a.equals(t.a) || this._a.equals(t.b) || this._a.equals(t.c) || this._a.equals(t.d)) &&
      (this._b.equals(t.a) || this._b.equals(t.b) || this._b.equals(t.c) || this._b.equals(t.d)) &&
      (this._c.equals(t.a) || this._c.equals(t.b) || this._c.equals(t.c) || this._c.equals(t.d)) &&
      (this._d.equals(t.a) || this._d.equals(t.b) || this._d.equals(t.c) || this._d.equals(t.d))
    );
  }
  getHashCode() {
